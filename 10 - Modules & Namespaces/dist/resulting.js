...
(function (DOInterfaces) {
    ...
    DOInterfaces.ListenerState = ListenerState;
    class ProjectState extends ListenerState {
        ...
        addProject(title, description, people) {
            let newProject = new DOInterfaces.Project(Math.random().toString(), title, description, people, DOInterfaces.ProjectStatus.Active);
    ...
    DOInterfaces.ProjectState = ProjectState;
    DOInterfaces.projectState = ProjectState.getInstance();
...
(function (DOInterfaces) {
    ...
    })(ProjectStatus = DOInterfaces.ProjectStatus || (DOInterfaces.ProjectStatus = {}));
    class Project {
    ...
    class ProjectInput extends BaseProjectTemplate {
        ...
        getFormValues(event) {
            ...
            if (Array.isArray(formResult)) {
                ...
                DOInterfaces.projectState.addProject(title, desc, people);
    ...
    class ProjectList extends BaseProjectTemplate {
        ...
        configure() {
            ...
            DOInterfaces.projectState.addListener((projects) => {
        ...
        dropHandler(event) {
            ...
            DOInterfaces.projectState.moveProject(id, this.type === "active" ? ProjectStatus.Active : ProjectStatus.Finished);
        }
    }
    __decorate([
        Autobind
